...
cp ~/.config/alacritty/alacritty.toml ~/GitHub/my-config/alacritty/
cp ~/.config/fish/set-wallpapers.fish ~/GitHub/my-config/fish/
...
cp ~/.config/yazi/* ~/GitHub/my-config/yazi/
